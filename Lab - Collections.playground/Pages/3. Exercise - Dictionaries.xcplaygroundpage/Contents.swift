 ...
 */
var diction: [String: Int] = ["January": 31, "February": 28, "March": 31]
...
diction.updateValue(29, forKey: "February")
print(diction)
...
var shapesArray: [String] = ["circle"]
var colorsArray: [String] = ["yellow", "red" ]
var dic: [String: [String]] = ["Shapes": shapesArray, "colors": colorsArray]
print(dic)
