 ...
 */
var walking: [String] = ["Walk Bowling", "Walk Eating"]
var running: [String] = ["Run Bowling", "Run Eating"]
...
var mathew = running[0]
print(mathew)

//:  All of the challenges will reset at the end of the month. Use the `removeAll` to remove everything from `challenges`. Print `challenges`.
var Mathews: () = challenges.removeAll()
print(Mathews)
...
}else if namer.count == 1{
    print("The challege you have chosen is \(namer)")
}else{
